%% Model equations With AGE degradation Treatment
function output = glomerular_fibrosis_AGE_deg(t,y,Param_vals,g_conc,timespan,yo)
    AGE = y(1);
    P = y(2);
    M = y(3);
    T_B = y(4);
    ...
    dAGEdt = (L_AGE*gluc^m) - d_AGE*AGE*K_I; 
