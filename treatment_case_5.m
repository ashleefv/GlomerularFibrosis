...
% treatment_case_5: Predicting AGE degradation short term
%%%%%%%%%%%% Input and Outputs %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Run the without-AGE-deg model (no treatment)
...
% Run the with-AGE-deg model (Simulation period with treatment)
...
options = odeset('AbsTol',1e-16,'RelTol',1e-16);
[t_treat,y_treat] = ode23(@(t,y)glomerular_fibrosis_AGE_deg(t,y,param_vals,g_treatment,timespan_treatment,y_I),timespan_treatment,y_I,options);
